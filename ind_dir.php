		...
		<tr>
			...
			<?php
				...
				foreach($archivos_fechas as $key => $val)
				{
					...
					if(substr($val,2,2)=="01") $mes_disp[]="Enero";
...
<table border="0" align="center">
	<tr>
		<td>
			<?php
			if($imagen_reporte!="" && file_exists($Dir."/Archivos_Indicadores_Direccion/$cad2/$imagen_reporte.jpg"))
			{
				?>
				<img border="0" src="Archivos_Indicadores_Direccion/<?php echo $cad2."/".$imagen_reporte; ?>.jpg" />
				<?php
			}
			?>
		</td>
