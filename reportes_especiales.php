...
<script language="javascript">
	var ruta="<?php echo addslashes(dirname(__FILE__));?>/Archivos_Reportes_Especiales";
	var revisar=<?php
					...
					if(dirs[x]!="." && dirs[x]!="..")
					{
						...
						if(estatus=="")
						{
							...
							else
							{
								...
								if(revisar)
								{
									$('celda_revision').innerHTML='<label onclick="Revisar()"><input type="checkbox" value="" id="revision" />Revisado</label>';
								}
								else
								{
									$('celda_revision').innerHTML='';
	...
	{
		obj = new Ajax.Request("Archivos_Reportes_Especiales/"+Arch,{
			onSuccess: function(xhr)
			{
...
<table bgcolor='f2f2f2' width='100%' height='40' border='0' align='center' cellpadding='0' cellspacing='0'>
  <tr>
    ...
    <td width="31%"><div align='center'><strong>Reportes Especiales</strong></div></td>
...
<table border="0" align="center">
	<tr>
		...
		<td align="left" width="150"><select name="doctos" id="doctos" onchange="Archivos();"></select></td>
	...
	<tr>
		...
		<td align="left" width="50"><img src="Imagenes/back.png" border="0" onclick="GoRef(-1)" /> <img src="Imagenes/next.png" border="0" onclick="GoRef(+1)" /></td>
		<td colspan="3"></td>
	</tr>
</table>
