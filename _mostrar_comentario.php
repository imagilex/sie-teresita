...
if($id_reporte!="" && $comentarios=mysql_quer("select fecha, comentario, concat(nombre,' ', apaterno) as nombre from reporte_comentarios, usuario where id_reporte='$id_reporte' and reporte_comentarios.id_usuario=usuario.id_usuario order by nombre,fecha"))
{
	?>
	<dl>
	<?php
