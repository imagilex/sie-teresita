...
/* }}} */
        ...
        * @type String
        */
        STR_COLLAPSE: 'Oculta Barra de Herramientas',
        /**
        * @property STR_EXPAND
        * @description String for Toolbar Collapse Button - Expand
        * @type String
        */
        STR_EXPAND: 'Expandir Barra de Herramientas',
        /**
        ...
        * @type String
        */
        STR_SPIN_LABEL: 'Boton Spin con valor {VALUE}. Utilice control de desplazamiento para aumentar o disminuir el valor.',
        /**
        * @property STR_SPIN_UP
        * @description String for spinbutton up
        * @type String
        */
        STR_SPIN_UP: 'Clic para incrementar el valor',
        /**
        * @property STR_SPIN_DOWN
        * @description String for spinbutton down
        * @type String
        */
        STR_SPIN_DOWN: 'Clic para disminuir el valor',
        /**
        * @property _titlebar
        ...
        init: function(p_oElement, p_oAttributes) {
            ...
            if (!this._defaultToolbar) {
                this._defaultToolbar = {
                    ...
                    draggable: false,
                    buttons: [
                        { group: 'fontstyle', label: 'Fuente y Tama&ntilde;o',
                            buttons: [
                                { type: 'select', label: 'Fuente', value: 'fontname', disabled: true,
                                    menu: [
                        ...
                        { group: 'textstyle', label: 'Estilo',
                            buttons: [
                                ...
                                { type: 'push', label: 'Tachado', value: 'strikethrough' },
                                { type: 'separator' },
                        ...
                        { group: 'indentlist', label: 'Listas',
                            buttons: [
                                { type: 'push', label: 'Crear una Lista Desordenada', value: 'insertunorderedlist' },
                                { type: 'push', label: 'Crear una Lista Ordenada', value: 'insertorderedlist' }
                            ]
                        },
                        { type: 'separator' },
                        { group: 'insertitem', label: 'Insertar',
                            buttons: [
                                { type: 'push', label: 'Hipervinculo CTRL + SHIFT + L', value: 'createlink', disabled: true },
